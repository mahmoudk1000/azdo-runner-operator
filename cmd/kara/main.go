...
import (
	...
	webhookkarav1 "github.com/mahmoudk1000/azdo-runner-operator/internal/webhook/v1"
)
...
func init() {
	...
	utilruntime.Must(karav1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "59639842.kara.felukka.org",
	...
	// Create the pod service for managing runner agent pods
	podService := runners.NewPodService(mgr.GetClient())

	// Create and configure the controller with its dependencies
	...
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err = webhookkarav1.SetupRunnerPoolWebhookWithManager(mgr); err != nil {
